...
$(document).ready(()=>{
    projetos.forEach(element => {
        ...
        // div = div.replace('{projectName}',element.projeto)
        // div = div.replace('{text}',element.texto)
        
    });
})
// $('.projectmodal').on('show.bs.modal', function (event) {
//     var button = $(event.relatedTarget) // Button that triggered the modal
//     var recipient = button.data('desc') // Extract info from data-* attributes
//     var projeto = button.data('project') // Extract info from data-* attributes
//     var modal = $(this)
//     modal.find('.modal-title').html(projeto)
//     modal.find('.project-content').html(recipient)
// })